...
const Mobile = ({ scroll }: any) => {
    ...
    return (
        <div className={`relative h-full w-screen overflow-hidden flex items-center justify-center`}>
            <a href="/" className="transform hover:scale-110 transition-all duration-500 ease-in-out p-5 cursor-pointer z-20">
            ...
            <div className=" flex flex-col space-y-5 items-center justify-center bottom-0 right-0 p-5 w-2/5 z-10 rounded-tl-xl bg-black bg-opacity-40 backdrop-filter backdrop-blur-sm">
