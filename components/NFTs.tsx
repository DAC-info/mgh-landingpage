...
const NFTs = ({ show, animate }: any) => {
    ...
    return (
        ...
        <><div className="relative lg:absolute right-0 flex flex-col p-10 w-full lg:w-1/2 z-10 text-gray-200 text-center lg:text-right">
        ...
        <div className={`z-10 px-5 relative lg:absolute left-0 lg:left-20 xl:left-36 flex space-x-3  ${animate && "animate__animated"} ${show == 2 ? "animate__zoomIn" : "animate__zoomOut"}`}>
                <div className={` flex flex-col space-y-3 items-center justify-center ${show == 2 ? "transition-transform duration-40000 transform translate-y-0 lg:translate-y-full ease-linear" : ""}  `}>
